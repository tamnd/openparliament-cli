...
// the HTTP client, request shaping, and the typed data models for openparliament.
//
...
// DefaultUserAgent identifies the client to openparliament. A real, honest
// User-Agent is both polite and the thing most likely to keep you unblocked.
const DefaultUserAgent = "openparliament/dev (+https://github.com/tamnd/openparliament-cli)"

// Host is the site this client talks to, and the host the URI driver in
// domain.go claims. The scaffold points it at openparliament.com; change it once you
// know the real endpoints you want to read.
const Host = "openparliament.com"

// BaseURL is the root every request is built from.
const BaseURL = "https://" + Host

// Client talks to openparliament over HTTP.
type Client struct {
	HTTP      *http.Client
	UserAgent string
...
// path that names it on openparliament.com. It is a stand-in for the typed records you
// will model from the real openparliament endpoints.
//
// The kit struct tags make it addressable as a resource URI (see domain.go): ID
// is the URI id, and Body is the long text `openparliament cat` and the Markdown
...
// a row, though it still rides in `-o json` and `openparliament cat`. Swap `-` for
...
// openparliament.com page URI a host can follow. Like the rest of the scaffold it is a

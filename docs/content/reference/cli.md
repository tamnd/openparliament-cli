...
```
openparliament <command> [arguments] [flags]
```

Run `openparliament <command> --help` for the full flag list on any command. This
...
| `search <query>` | Search openparliament |
...
a row here per operation you declare in `openparliament/domain.go`.

...
Most of these come down to network reality or how openparliament serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openparliament rate-limits like any public site. openparliament already paces
...
Where a surface is gated, openparliament reads a cookie or token you supply
...
`openparliament`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openparliament actually did
